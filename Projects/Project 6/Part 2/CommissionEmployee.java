public class CommissionEmployee extends Employee {
    ...
    public boolean equals(Object o) {
        ...
        if (getSales() != that.getSales()) return false;
        if (getPercentOfSales() != that.getPercentOfSales()) return false;
    ...
    public String toString() {
        return "CommissionEmployee extends" +
                super.toString() +
                "\nSales: " + sales +
                "\nPercentage of Sales: " + percentOfSales;
    }
}
